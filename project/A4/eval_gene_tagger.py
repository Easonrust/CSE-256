...
class Evaluator(object):
    ...
    def compare(self, gold_standard, prediction):
        ...
        for gs_word, gs_tag in gold_standard:  # Move through the gold standard stream
            ...
            pred_word, pred_tag = next(prediction)
            ...
            gs_ends = curr_gs_type != None and ((gs_tag == None or gs_tag[0] in "OB") or (
                curr_gs_type != gs_type and gs_tag[0] == "I"))
            ...
            if pred_word != None:
                pred_start = (pred_tag != None and pred_tag[0] == "B") or (curr_pred_type == None and pred_tag[0] == "I") or \
                    (curr_pred_type != None and curr_pred_type !=
                     pred_type and pred_tag.startswith("I"))
                gs_starts = (gs_tag != None and gs_tag[0] == "B") or (curr_gs_type == None and gs_tag[0] == "I") or \
                    (curr_gs_type != None and curr_gs_type !=
                     gs_type and gs_tag.startswith("I"))
            else:
                pred_start = False
                gs_starts = False
            ...
            elif curr_pred_type == None and curr_pred_type == None:
                self.tn += 1
                for c in self.ne_classes:
    ...
    def print_scores(self):
        ...
        if self.tp + self.tn + self.fp + self.fn == 0:
            ...
            acc = (self.tp + self.tn) / \
                float(self.tp + self.tn + self.fp + self.fn)
